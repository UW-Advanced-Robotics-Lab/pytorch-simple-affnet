...
def main():
    ...
    for image_idx, (images, targets) in enumerate(test_loader):
        ...
        print(f'True Positives: {tp}/{num_pred},\t',
              f'False Positives: {fp}/{num_pred},\t',
              f'False Negative: {fn}/{num_pred},\t',
              f'True Negative: {tn}/{num_pred}\t',
              )
        if tp > 0:
    ...
    # Precision and Recall
    print(f"\nnum gt: {NUM_GTs},\t num preds: {NUM_PREDs}")
    print(f'True Positives: {TPs}/{NUM_PREDs},\t',
          f'False Positives: {FPs}/{NUM_PREDs},\t',
          f'False Negative: {FNs}/{NUM_PREDs},\t',
          f'True Negative: {TNs}/{NUM_PREDs}\t',
          )
    if TPs > 0:
